...
class IndexView(TemplateView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        newimgdir = 'media/{}_{}.tar'.format(img, tag.replace(':', '@'))
        print(newimgdir,"这是文件位置")
        ...
        imgdir = 'tmp_{}_{}.tar'.format(img, tag.replace(':', '@'))
        os.mkdir(imgdir)
        ...
        print(registry, repository, tag,"这是")

        # Create image tar and clean tmp folder
        docker_tar = "media/" + imgdir.replace("tmp_","")
